...
Item {
    ...
    Rectangle {
        ...
        Row {
            ...
            CheckBox {
                id: chkMulti
                font.pixelSize: 16
                text: qsTr("Specimen.MultiSelect")
                Material.background: "white"
                Material.foreground: "#535353"
                height: 46
                onClicked: {
    ...
    Rectangle {
        ...
        Label {
            ...
            anchors.margins: 8
            anchors.leftMargin: 18
            text: qsTr("Specimen.SpecimenInfo")
            font.pixelSize: layBaseEditor.lblFontSize
            font.bold: false
            Material.foreground: Themer.editorFontColor
        }
        ...
        Flow {
            ...
            Row {
                ...
                TextField {
                    ...
                    property string txtY: qsTr("Specimen.AgeY")
                    property string txtM: qsTr("Specimen.AgeM")
                    property string txtD: qsTr("Specimen.AgeD")
            ...
            Row {
                ...
                Label {
                    ...
                    verticalAlignment: Text.AlignVCenter
                    horizontalAlignment: Text.AlignRight
                    text: qsTr("Specimen.OutpatientNo")
                    font.pixelSize: layBaseEditor.lblFontSize
                    Material.foreground: Themer.editorFontColor
                }
                TextField {
            ...
            Row {
                ...
                Label {
                    ...
                    verticalAlignment: Text.AlignVCenter
                    horizontalAlignment: Text.AlignRight
                    text: qsTr("Specimen.InpatientNo")
                    font.pixelSize: layBaseEditor.lblFontSize
                    Material.foreground: Themer.editorFontColor
                }
                TextField {
            ...
            Row {
                ...
                Label {
                    ...
                    verticalAlignment: Text.AlignVCenter
                    horizontalAlignment: Text.AlignRight
                    text: qsTr("Specimen.SpecimenQuality")
                    font.pixelSize: layBaseEditor.lblFontSize
                    Material.foreground: Themer.editorFontColor
            ...
            Row {
                ...
                Label {
                    ...
                    verticalAlignment: Text.AlignVCenter
                    horizontalAlignment: Text.AlignRight
                    text: qsTr("Specimen.CollectionTime")
                    font.pixelSize: layBaseEditor.lblFontSize
                    Material.foreground: Themer.editorFontColor
                }
                DateField {
    ...
    function savePatientInfo() {
        if (edtTestId.text.trim() === "") {
            openDialogPrompt("Specimen.TestIdDontEmpty");
            return 1;
        }
        ...
        for (var i = 0; i < layBaseEditor.children.length; i++) {
            ...
            if (String(child).indexOf("TextField") !== -1) {
                ...
                if (!isDateString(child.editText.trim())) {
                    var info = child.lblTitle + qsTr("Specimen.DateFormatError");
