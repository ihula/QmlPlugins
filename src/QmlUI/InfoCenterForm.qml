...
HulaDialog {
    ...
    Rectangle {
        ...
        HulaTableView {
            ...
            headerTitles: ["Id", "InfoCenter.ErrorNum", "InfoCenter.ErrorInfo", "InfoCenter.UserName", "InfoCenter.LogTime"]
            model: TableModel {
                TableModelColumn {
                    id: colId
                    display: "Id"
    ...
    function loadDatas() {
        ...
        var dataList = InfoCenter.getDatas(strDate)
    ...
    function deleteData() {
        ...
        var funcDelete = function () {
            ...
            var ret = infoCenter.deleteData(data.Id)
            if (ret === 0) {
    ...
    function deleteAllData() {
        var funcDelete = function () {
            var ret = InfoCenter.deleteAllData()
            if (ret === 0) {
                tableview.model.clear()
                clearEditor()
                snackMessage("DeleteValid")
